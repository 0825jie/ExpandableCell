...
class ProductCell : UITableViewCell {
    ...
    private let bar2 : UIView = {
        let vi = UIView()
        vi.backgroundColor = UIColor(red: 0.1961, green: 0.5569, blue: 0.0863, alpha: 1.0)
        return vi
    }()
...
//        productImage.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: nil, paddingTop: 5, paddingLeft: 5, paddingBottom: 5, paddingRight: 0, width: 90, height: 0, enableInsets: false)
        productNameLabel.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 20, paddingLeft: 10, paddingBottom: 0, paddingRight: 0, width: frame.size.width / 2, height: 0, enableInsets: false)
        productDescriptionLabel.anchor(top: productNameLabel.bottomAnchor, left: rightAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 10, paddingBottom: 0, paddingRight: 0, width: frame.size.width / 2, height: 0, enableInsets: false)
        
        bar.anchor(top: nil, left: nil, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 10, paddingRight: 20, width: 4, height: 50, enableInsets: false)
//        bar.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        
        
        bar2.anchor(top: nil, left: nil, bottom: bottomAnchor, right: bar.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 10, paddingRight: 5, width: 4, height: 70, enableInsets: false)
//        bar2.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
